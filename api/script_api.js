...
async function ambilDataAPI() {
    const url = 'api_bps.php'; // Pastikan file ini ada di folder yang sama
    ...
    try {
        ...
        if (container) {
            container.innerHTML = `<p class="text-red-500 text-xs italic">Koneksi ke API atau file api_bps.php bermasalah.</p>`;
        }
    }
}
