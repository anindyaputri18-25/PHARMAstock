...
if (isset($_POST['tambah_obat'])) {
    ...
    $cek_nama = mysqli_query($conn, "SELECT * FROM medicines WHERE LOWER(nama_obat) = LOWER('$nama')");
...
<body class="text-slate-800 flex min-h-screen">
    ...
    <main class="flex-1 p-6 md:p-10 lg:p-12 max-w-[1600px] mx-auto w-full">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            ...
            $q_limit = mysqli_query($conn, "SELECT COUNT(*) as total FROM medicines WHERE jumlah > 0 AND jumlah < 30");
            ...
            $q_exp = mysqli_query($conn, "SELECT COUNT(*) as total FROM medicines WHERE expired_date <= '$warning_date'");
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left" id="obatTable">
                        ...
                        <tbody class="divide-y divide-slate-50">
                            <?php
                            $res = mysqli_query($conn, "SELECT * FROM medicines ORDER BY id DESC");
