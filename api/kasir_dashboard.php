...
// Proteksi: Hanya Kasir yang boleh masuk ke file ini
...
$stok_aman = mysqli_num_rows(mysqli_query($conn, "SELECT id FROM medicines WHERE jumlah > 15"));
$stok_menipis = mysqli_num_rows(mysqli_query($conn, "SELECT id FROM medicines WHERE jumlah > 0 AND jumlah <= 15"));
$stok_habis = mysqli_num_rows(mysqli_query($conn, "SELECT id FROM medicines WHERE jumlah <= 0"));
?>
    ...
    <main class="flex-1 p-6 md:p-10 lg:p-12 max-w-[1600px] mx-auto w-full">
        ...
        <div class="group relative overflow-hidden bg-gradient-to-br from-blue-600 to-indigo-700 p-10 rounded-[2.5rem] text-white mb-10 smooth-shadow transition-transform hover:scale-[1.005]">
            <div class="relative z-10">
                ...
                <h2 class="text-4xl font-black italic mb-3 tracking-tight">Halo, <?php echo htmlspecialchars($user); ?>! 👋</h2>
